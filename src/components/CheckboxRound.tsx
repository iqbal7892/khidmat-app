...
const CustomeCheckboxRound = (props: any) => {
    ...
    return (
        <Pressable onPress={toggleSwitch} style={[styles.container,props.containerStyle]}>
            ...
            {props.customCheck && isEnabled  && <Image style={{ width: WidthToDp(24), height: HeightToDp(24),marginRight:WidthToDp(8), resizeMode: 'contain' }} source={require('../assets/images/icons/tick-square-active.png')} />}
            {props.customCheck && !isEnabled  && <Image style={{ width: WidthToDp(24), height: HeightToDp(24),marginRight:WidthToDp(8), resizeMode: 'contain' }} source={require('../assets/images/icons/tick-square-round.png')} />}
...
export default CustomeCheckboxRound
